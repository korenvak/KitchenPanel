...
class PanelKitchensApp:
    ...
    def create_customer_form(self):
        ...
        date_button = ft.ElevatedButton(
            ...
            style=ft.ButtonStyle(
                color={ft.MaterialState.DEFAULT: "#d32f2f"},
                bgcolor={ft.MaterialState.DEFAULT: "#ffebee"},
                padding=20,
                animation_duration=300,
            ),
    ...
    def create_catalog_section(self):
        ...
        self.upload_container = ft.Container(
            ...
            padding=60,
            border=ft.border.all(3, "#ff6f00", style=ft.BorderStyle.DASHED),
            border_radius=20,
    ...
    def create_pdf_section(self):
        ...
        reset_button = ft.OutlinedButton(
            ...
            style=ft.ButtonStyle(
                side={ft.MaterialState.DEFAULT: ft.BorderSide(2, "#d32f2f")},
                padding=20,
                shape=ft.RoundedRectangleBorder(radius=10),
            ),
